	          ...
	          <div class="position-sticky pt-md-5">
                        ...
                        <div class="row">
                           <div class="col-lg-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <input type="text" class="form-control" name="namestudent" value="<?php echo $rows['Candidate_Name'] ?>" required>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <input type="text" class="form-control" name="matric" value="<?php echo $rows['Candidate_Matric'] ?>" required>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <select class="form-control" name="faculty" required>
                                       ...
                                       <option <?php echo $rows['Candidate_Faculty'] == 'FK' ? 'selected' : '' ?> value="FK">FAKULTI KOMPUTERAN</option>
                                       <option <?php echo $rows['Candidate_Faculty'] == '2' ? 'selected' : '' ?>value="2">2</option>
                                       <option <?php echo $rows['Candidate_Faculty'] == '3' ? 'selected' : '' ?>value="3">3</option>
                                       <option <?php echo $rows['Candidate_Faculty'] == '4' ? 'selected' : '' ?>value="4">4</option> 
                                    </select>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <select class="form-control" name="year" required>
                                       ...
                                       <option <?php echo $rows['Year'] == '1' ? 'selected' : '' ?> value="1">1</option>
                                       <option <?php echo $rows['Year'] == '2' ? 'selected' : '' ?> value="2">2</option>
                                       <option <?php echo $rows['Year'] == '3' ? 'selected' : '' ?> value="3">3</option>
                                       <option <?php echo $rows['Year'] == '4' ? 'selected' : '' ?> value="3">4</option> 
                                    </select>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <select class="form-control" name="semester" required>
                                       ...
                                       <option <?php echo $rows['Semester'] == '1' ? 'selected' : '' ?> value="1">1</option>
                                       <option <?php echo $rows['Semester'] == '2' ? 'selected' : '' ?> value="2">2</option>
                                       <option <?php echo $rows['Semester'] == '3' ? 'selected' : '' ?> value="3">3</option>
                                    </select>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <textarea class="form-control" name="slogan" rows="3" cols="150"><?php echo $rows['Candidate_Slogan'] ?></textarea>
                           ...
                           <div class="col-lg-6">
                              <div class="form-group row">
                                 <div class="d-flex flex-row">
                                    ...
                                    <div class="p-2"><img src="../../image/<?php echo $rows['Candidate_Photo'] ?>" width="40%" height="">
                                    <div class="p-2">
                                       <div class="d-flex flex-column">
                                          <div class="p-2"><input type="file" name="studphoto" class="form-control-plaintext"></div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
               ...
               <div class="row mb-4">
                     <div class="col-lg-12 border-bottom">
                        ...
                        <div class="row">
                           <div class="col-lg-5">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="number" onchange="setTwoNumberDecimal" min="0" max="300" step="0.01" value="<?php echo $rows['Academic'] ?>" class="form-control" name="Academic" required>
                                 </div>
                              </div>
                              <br>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="number" onchange="setTwoNumberDecimal" min="0" max="300" step="0.01"  value="<?php echo $rows['Kesukarelawan'] ?>" class="form-control" pattern=".{12,12}" name="Kesukarelawan" required>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-lg-7">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="number" onchange="setTwoNumberDecimal" min="0" max="300" step="0.01"  value="<?php echo $rows['Leadership'] ?>" class="form-control" name="Leadership" required><br>
                                 </div>
                              </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="number" onchange="setTwoNumberDecimal" min="0" max="300" step="0.01"  value="<?php echo $rows['CommunityService'] ?>" class="form-control" pattern=".{12,12}" name="CommunityService" required><br>
                                 </div>
                              </div>
                           </div>
                        <br>
                        ...
                        <div class="col-lg-5">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="number" onchange="setTwoNumberDecimal" min="0" max="300" step="0.01"  value="<?php echo $rows['Kesukanan'] ?>" class="form-control" name="Kesukanan" required>
                                 </div>
                              </div>
                              <br>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="number" onchange="setTwoNumberDecimal" min="0" max="300" step="0.01"  value="<?php echo $rows['Kebudayaan'] ?>" class="form-control" pattern=".{12,12}" name="Kebudayaan" required>
                                 </div>
                              </div>
                           </div>
                        <br>
                        <div class="col-lg-7">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="number" onchange="setTwoNumberDecimal" min="0" max="300" step="0.01"  value="<?php echo $rows['PengucapanAwam'] ?>" class="form-control" name="PengucapanAwam" required>
                                 </div>
                              </div>
                              <br>
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-7">
                                    <input type="number" onchange="setTwoNumberDecimal" min="0" max="300" step="0.01"  value="<?php echo $rows['DayaUsahaInovasi'] ?>" class="form-control" pattern=".{12,12}" name="DayaUsahaInovasi" required>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="row mb-10" >
                     ...
                     <input type="hidden" name="Candidate_ID" value="<?php echo $rows['Candidate_ID'] ?>">
